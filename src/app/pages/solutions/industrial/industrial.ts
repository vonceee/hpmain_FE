...
import { NewsArticles } from 'src/app/components/news-articles/news-articles';

@Component({ 
  selector: 'industrial',
  standalone: true,
  imports: [CommonModule, BackToTopComponent, MainHeader, MainFooter, HeroSection, DecorGlowComponent, IconCards, NewsArticles, TitleBadge],
  templateUrl: './industrial.html',
  styleUrl: './industrial.scss',
})
export class Industrial implements OnInit, OnDestroy {
  ...
  products = 
    ...
    {
      title: 'Innovation Machine Shop Technology',
    ...
    {
      title: 'Professional Constructional Tools and Equipment',
      desc: 'One-step solution for accurate bolt joint assembly eliminates over and under torqueing during maintenance activities and maximizes tool capabilities.',
      icon: 'bi bi-building',
    },
    {
      title: 'Skill Enchancement Program',
      desc: 'One-step solution for accurate bolt joint assembly eliminates over and under torqueing during maintenance activities and maximizes tool capabilities.',
      icon: 'bi bi-key',
    },
  ];
  ...
  specialist = 
    ...
    news = [{
      ...
      img: '/assets/images/news/ind-1.png',
      desc:
    ...
    },
    {
      ...
      img: '/assets/images/news/ind-2.png',
      desc: 'Helping factories reduce carbon footprint with our new green energy systems.',
    },
    {
      title: 'Robotics Integration in Logistics',
      date: '05 January 2026',
      img: '/assets/images/news/ind-3.png',
      desc: 'Streamlining logistics operations with advanced robotics and AI integration.',
    },
    {
      title: 'IoT Solutions for Smart Manufacturing',
      date: '28 November 2025',
      img: '/assets/images/news/ind-4.png',
      desc: 'Connecting machines and data for smarter, data-driven manufacturing decisions.',
    },
  ];
